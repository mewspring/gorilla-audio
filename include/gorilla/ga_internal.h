...
Data structures and functions used internally by Gorilla Audio.
*/
...
/*  Sample Source  */
/*******************/
/** \defgroup intSampleSource Sample Source
\ingroup internal
Internal sample source object definition.
*/
...
typedef struct MULTI_CLIENT ga_SampleSource {
...
/*  Memory  */
/************/
/** \defgroup intMemory Memory
\ingroup internal
Internal memory object definition.
*/
/* [\ref MULTI_CLIENT] */
typedef struct MULTI_CLIENT ga_Memory {
  void* data;
  gc_uint32 size;
  gc_int32 refCount;
  gc_Mutex* refMutex;
...
/*  Sound  */
/***********/
/** \defgroup intSound Sound
\ingroup internal
Internal sound object definition.
*/
/* [\ref MULTI_CLIENT] */
typedef struct MULTI_CLIENT ga_Sound {
  ga_Memory* memory;
  ga_Format format;
  gc_int32 numSamples;
  gc_int32 refCount;
...
/*  Handle  */
/************/
/** \defgroup intHandle Handle
\ingroup internal
Internal handle object definition.
*/

/** Enumerated handle state values.
 *
 *  Used internally to control
 *
 *  \ingroup intHandle
...
/* [\ref SINGLE_CLIENT] */
typedef struct SINGLE_CLIENT ga_Handle {
  ga_Mixer* mixer;
...
/*  Mixer  */
/************/
/** \defgroup intMixer Mixer
\ingroup internal
Internal mixer object definition.
*/
/* [\ref SINGLE_CLIENT] */
typedef struct SINGLE_CLIENT ga_Mixer {
  ga_Format format;
  ga_Format mixFormat;
  gc_int32 numSamples;
  gc_int32* mixBuffer;
